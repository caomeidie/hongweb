...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="check" postType="string" href="?r=goodstype/del" class="delete"><span>删除</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<?php foreach($list as $value): ?>
    		<tr target="sid" rel="<?php echo $value['type_id']; ?>">
                ...
                <td>
                    <a title="删除" target="ajaxTodo" href="?r=goodstype/del&uid=<?php echo $value['type_id']; ?>" class="btnDel">删除</a>
					<a title="编辑" target="navTab" href="?r=goodstype/edit&uid=<?php echo $value['type_id']; ?>" class="btnEdit">编辑</a>
                </td>
			</tr>
		<?php endforeach; ?>
		</tbody>
