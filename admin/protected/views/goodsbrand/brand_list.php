...
?>
<form id="pagerForm" method="post" action="?r=goodsbrand/index">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="?r=goodsbrand/index" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="check" postType="string" href="?r=goodsbrand/del" class="delete"><span>删除</span></a></li>
