...
?>
<form id="pagerForm" method="post" action="?r=member/index">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="?r=member/index" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="add" href="?r=member/add" target="navTab"><span>添加</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="check" postType="string" href="?r=member/del" class="delete"><span>删除</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<?php foreach($list as $value): ?>
    		<tr target="sid" rel="<?php echo $value['member_id']; ?>">
    		    <td><label><input type="checkbox" name="check" value="<?php echo $value['member_id']; ?>" /></label></td>
        		<td><?php echo $value['member_id']; ?></td>
                <td><?php echo $value['member_name']; ?></td>
                <td><?php echo $value['member_mobile']; ?></td>
                <td><?php echo $value['member_truename']; ?></td>
                <td><?php echo $value['member_idcard']; ?></td>
                <td><?php echo $value['member_email']; ?></td>
                <td><?php echo $value['member_points']; ?></td>
                <td><?php echo $value['member_state']; ?></td>
                <td><?php echo $value['member_vip']; ?></td>
                <td>
                    <a title="删除" target="ajaxTodo" href="?r=member/del&uid=<?php echo $value['member_id']; ?>" class="btnDel">删除</a>
					<a title="编辑" target="navTab" href="?r=member/edit&uid=<?php echo $value['member_id']; ?>" class="btnEdit">编辑</a>
                </td>
			</tr>
		<?php endforeach; ?>
		</tbody>
