...
<div class="pageContent">
	<form method="post" action="?r=articleclass/add" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<dl>
			<dt>分类名称：</dt>
			<dd>
		        <input name="ACForm[acname]" id="ACForm_acname" type="text"  class="required" />
		    </dd>
		</dl>
		<dl>
			<dt>分类代码：</dt>
			<dd>
		        <input name="ACForm[accode]" id="ACForm_accode" type="text"  />
		    </dd>
		</dl>
		<dl>
			<dt>上级分类：</dt>
		...
		<dl>
			<dt>排序：</dt>
			<dd>
		        <input name="ACForm[acsort]" id="ACForm_acsort" type="text" value="255" class="required" />
		    </dd>
		</dl>
		</div>
		<div class="formBar">
