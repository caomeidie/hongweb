...
?>
<form id="pagerForm" method="post" action="?r=articleclass/index">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="?r=articleclass/index" method="post">
	<div class="searchBar">
	...
	<table class="table" width="100%" layoutH="138">
		...
		<?php foreach($list as $value): ?>
    		<tr target="sid" rel="<?php echo $value['ac_id']; ?>">
                ...
                <td>
                    <a class="delete" href="?r=articleclass/del&sid=<?php echo $value['ac_id']; ?>" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a>
                    <a class="edit" href="?r=articleclass/edit&sid=<?php echo $value['ac_id']; ?>" target="navTab"><span>修改</span></a>
                </td>
			</tr>
		<?php endforeach; ?>
		</tbody>
