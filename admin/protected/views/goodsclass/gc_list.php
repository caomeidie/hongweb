...
?>
<form id="pagerForm" method="post" action="?r=goodsclass/index">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="?r=goodsclass/index" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
		<?php foreach($list_tree as $value): ?>
    		<tr target="sid" rel="<?php echo $value['val']['gc_id']; ?>">
