...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="check" postType="string" href="?r=adminstyle/del" class="delete"><span>删除</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<?php foreach($list as $value): ?>
    		<tr target="sid" rel="<?php echo $value['style_id']; ?>">
                ...
                <td>
                    <a title="删除" target="ajaxTodo" href="?r=adminstyle/del&uid=<?php echo $value['style_id']; ?>" class="btnDel">删除</a>
					<a title="编辑" target="navTab" href="?r=adminstyle/edit&uid=<?php echo $value['style_id']; ?>" class="btnEdit">编辑</a>
                </td>
			</tr>
		<?php endforeach; ?>
		</tbody>
