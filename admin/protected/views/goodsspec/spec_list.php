...
?>
<form id="pagerForm" method="post" action="?r=goodsspec/index">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="?r=goodsspec/index" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="add" href="?r=goodsspec/add" target="navTab"><span>添加</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="check" postType="string" href="?r=goodsspec/del" class="delete"><span>删除</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<?php foreach($list as $value): ?>
    		<tr target="sid" rel="<?php echo $value['spec_id']; ?>">
    		    <td><label><input type="checkbox" name="check" value="<?php echo $value['spec_id']; ?>" /></label></td>
        		<td><?php echo $value['spec_id']; ?></td>
                <td><?php echo $value['spec_name']; ?></td>
                <td><?php echo implode("，", unserialize($value['spec_value'])); ?></td>
                <td><?php echo $value['spec_sort']; ?></td>
                <td>
                    <a title="删除" target="ajaxTodo" href="?r=goodsspec/del&uid=<?php echo $value['spec_id']; ?>" class="btnDel">删除</a>
					<a title="编辑" target="navTab" href="?r=goodsspec/edit&uid=<?php echo $value['spec_id']; ?>" class="btnEdit">编辑</a>
                </td>
			</tr>
		<?php endforeach; ?>
		</tbody>
